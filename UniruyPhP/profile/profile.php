                    ...
                    <form class="container row align-items-center" action="edit.php" method="POST">
                        <div class="col">
                            ...
                            <div class="container d-flex flex-direction-row px-0 py-4">
                                <button type="button" class="btn container col-md-5 ms-0 p-0 btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#myModal2" id="myInput2">Salvar alterações</button>
                        ...
                        <div class="col d-flex flex-column">
                            ...
                            <button type="submit" name="delete" id="delete" class="btn container my-4 col-md-6 btn-danger">Deletar
                                conta</button>
                        </div>
                    </form>
                </div>
